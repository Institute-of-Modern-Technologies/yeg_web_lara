...
<div class="container mx-auto px-4 py-6">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold text-gray-800">Create New Trainer</h1>
        <a href="{{ route('admin.trainers.index') }}" class="text-primary hover:underline">
            <i class="fas fa-arrow-left mr-1"></i> Back to Trainers List
        </a>
    </div>
        ...
        <form action="{{ route('admin.trainers.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <div class="flex rounded-lg overflow-hidden border border-gray-300 focus-within:ring-2 focus-within:ring-[#950713] focus-within:border-[#950713] @error('name') border-red-500 @enderror">
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name') }}" class="flex-1 block w-full px-3 py-2 border-0 outline-none" placeholder="Full name" required>
                        </div>
                        @error('name')
                    ...
                    <div>
                        ...
                        <div class="flex rounded-lg overflow-hidden border border-gray-300 focus-within:ring-2 focus-within:ring-[#950713] focus-within:border-[#950713] @error('email') border-red-500 @enderror">
                            ...
                            <input type="email" name="email" id="email" value="{{ old('email') }}" class="flex-1 block w-full px-3 py-2 border-0 outline-none" placeholder="email@example.com" required>
                        </div>
                        @error('email')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <div class="flex rounded-lg overflow-hidden border border-gray-300 focus-within:ring-2 focus-within:ring-[#950713] focus-within:border-[#950713] @error('location') border-red-500 @enderror">
                            ...
                            <input type="text" name="location" id="location" value="{{ old('location') }}" class="flex-1 block w-full px-3 py-2 border-0 outline-none" placeholder="Residential area" required>
                        </div>
                        @error('location')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="flex rounded-lg overflow-hidden border border-gray-300 focus-within:ring-2 focus-within:ring-[#950713] focus-within:border-[#950713] @error('surrounding_areas') border-red-500 @enderror">
                            ...
                            <input type="text" name="surrounding_areas" id="surrounding_areas" value="{{ old('surrounding_areas') }}" class="flex-1 block w-full px-3 py-2 border-0 outline-none" placeholder="Other areas you can reach easily">
                        </div>
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="flex rounded-lg overflow-hidden border border-gray-300 focus-within:ring-2 focus-within:ring-[#950713] focus-within:ring-opacity-50 @error('educational_background') border-red-500 @enderror">
                            ...
                            <textarea name="educational_background" id="educational_background" rows="4" class="flex-1 block w-full px-3 py-2 border-0 outline-none" placeholder="Educational qualifications, degrees, certifications, etc." required>{{ old('educational_background') }}</textarea>
                        </div>
                    ...
                    <div>
                        ...
                        <div class="flex rounded-lg overflow-hidden border border-gray-300 focus-within:ring-2 focus-within:ring-[#950713] focus-within:ring-opacity-50 @error('relevant_experience') border-red-500 @enderror">
                            ...
                            <textarea name="relevant_experience" id="relevant_experience" rows="4" class="flex-1 block w-full px-3 py-2 border-0 outline-none" placeholder="Experience in technology or teaching related roles" required>{{ old('relevant_experience') }}</textarea>
                        </div>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                        ...
                        <div class="flex items-start">
                            <div class="flex items-center h-5">
                                <input type="checkbox" name="expertise_areas[]" id="digital_literacy" value="digital_literacy" class="w-5 h-5 rounded text-[#950713] focus:ring-[#950713]" {{ in_array('digital_literacy', old('expertise_areas', [])) ? 'checked' : '' }}>
                            </div>
                            <div class="ml-3">
                        ...
                        <div class="flex items-start">
                            <div class="flex items-center h-5">
                                <input type="checkbox" name="expertise_areas[]" id="graphic_design" value="graphic_design" class="w-5 h-5 rounded text-[#950713] focus:ring-[#950713]" {{ in_array('graphic_design', old('expertise_areas', [])) ? 'checked' : '' }}>
                            </div>
                            <div class="ml-3">
                        ...
                        <div class="flex items-start">
                            <div class="flex items-center h-5">
                                <input type="checkbox" name="expertise_areas[]" id="coding" value="coding" class="w-5 h-5 rounded text-[#950713] focus:ring-[#950713]" {{ in_array('coding', old('expertise_areas', [])) ? 'checked' : '' }}>
                            </div>
                            <div class="ml-3">
                        ...
                        <div class="flex items-start">
                            <div class="flex items-center h-5">
                                <input type="checkbox" name="expertise_areas[]" id="robotics" value="robotics" class="w-5 h-5 rounded text-[#950713] focus:ring-[#950713]" {{ in_array('robotics', old('expertise_areas', [])) ? 'checked' : '' }}>
                            </div>
                            <div class="ml-3">
                        ...
                        <div class="flex items-start">
                            <div class="flex items-center h-5">
                                <input type="checkbox" name="expertise_areas[]" id="entrepreneurship" value="entrepreneurship" class="w-5 h-5 rounded text-[#950713] focus:ring-[#950713]" {{ in_array('entrepreneurship', old('expertise_areas', [])) ? 'checked' : '' }}>
                            </div>
                            <div class="ml-3">
                        ...
                        <div class="flex items-start">
                            <div class="flex items-center h-5">
                                <input type="checkbox" name="expertise_areas[]" id="other_expertise_checkbox" value="other" class="w-5 h-5 rounded text-[#950713] focus:ring-[#950713]" {{ in_array('other', old('expertise_areas', [])) ? 'checked' : '' }}>
                            </div>
                            <div class="ml-3">
                    ...
                    <div class="mt-6">
                        ...
                        <div class="flex rounded-lg overflow-hidden border border-gray-300 focus-within:ring-2 focus-within:ring-[#950713] focus-within:ring-opacity-50 @error('specialization') border-red-500 @enderror">
                            ...
                            <input type="text" name="specialization" id="specialization" value="{{ old('specialization', '') }}" class="flex-1 block w-full px-3 py-2 border-0 outline-none" placeholder="Main area of expertise">
                        </div>
            ...
            <div class="p-6 sm:p-8 form-section bg-gray-50 border-b border-gray-200">
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <label class="relative border border-gray-300 rounded-lg p-4 cursor-pointer hover:bg-gray-50 transition-colors flex items-start">
                            <input type="radio" name="program_applied" value="regular_tech_classes" class="h-5 w-5 text-[#950713] focus:ring-[#950713] border-gray-300" {{ old('program_applied') == 'regular_tech_classes' ? 'checked' : '' }} required>
                            <div class="ml-3">
                        ...
                        <!-- Holiday Programs -->
                        <label class="relative border border-gray-300 rounded-lg p-4 cursor-pointer hover:bg-gray-50 transition-colors flex items-start">
                            <input type="radio" name="program_applied" value="holiday_programs" class="h-5 w-5 text-[#950713] focus:ring-[#950713] border-gray-300" {{ old('program_applied') == 'holiday_programs' ? 'checked' : '' }} required>
                            <div class="ml-3">
                        ...
                        <label class="relative border border-gray-300 rounded-lg p-4 cursor-pointer hover:bg-gray-50 transition-colors flex items-start md:col-span-2">
                            <input type="radio" name="program_applied" value="both_programs" class="h-5 w-5 text-[#950713] focus:ring-[#950713] border-gray-300" {{ old('program_applied') == 'both' ? 'checked' : '' }} required>
                            <div class="ml-3">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                        ...
                        <div class="flex items-start">
                            <div class="flex items-center h-5">
                                <input type="checkbox" name="preferred_locations[]" id="accra" value="accra" class="w-5 h-5 rounded text-[#950713] focus:ring-[#950713]" {{ in_array('accra', old('preferred_locations', [])) ? 'checked' : '' }}>
                            </div>
                            <div class="ml-3">
                                <label for="accra" class="text-gray-700">Accra</label>
                                <p class="text-gray-500 text-xs">Greater Accra Region</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start">
                            <div class="flex items-center h-5">
                                <input type="checkbox" name="preferred_locations[]" id="other_location_checkbox" value="other" class="w-5 h-5 rounded text-[#950713] focus:ring-[#950713]" {{ in_array('other', old('preferred_locations', [])) ? 'checked' : '' }}>
                            </div>
                            <div class="ml-3">
                                <label for="other_location_checkbox" class="text-gray-700">Other</label>
                                <p class="text-gray-500 text-xs">Specify below</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="other_location_container" class="mt-4 {{ in_array('other', old('preferred_locations', [])) ? '' : 'hidden' }}">
                        ...
                        <div class="flex rounded-lg overflow-hidden border border-gray-300 focus-within:ring-2 focus-within:ring-[#950713] focus-within:ring-opacity-50">
                            ...
                            <input type="text" name="other_location" id="other_location" value="{{ old('other_location', '') }}" class="flex-1 block w-full px-3 py-2 border-0 outline-none" placeholder="E.g., Tema, Dansoman, etc.">
                        </div>
                    </div>
            ...
            <div class="p-6 sm:p-8 form-section border-b border-gray-200">
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <!-- Yes -->
                        <label class="relative border border-gray-300 rounded-lg p-4 cursor-pointer hover:bg-gray-50 transition-colors flex items-start">
                            <input type="radio" name="experience_teaching_kids" value="1" class="h-5 w-5 text-[#950713] focus:ring-[#950713] border-gray-300" {{ old('experience_teaching_kids') == 1 ? 'checked' : '' }} required>
                            <div class="ml-3">
                        ...
                        <!-- No -->
                        <label class="relative border border-gray-300 rounded-lg p-4 cursor-pointer hover:bg-gray-50 transition-colors flex items-start">
                            <input type="radio" name="experience_teaching_kids" value="0" class="h-5 w-5 text-[#950713] focus:ring-[#950713] border-gray-300" {{ old('experience_teaching_kids') == 0 ? 'checked' : '' }} required>
                            <div class="ml-3">
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <!-- Yes (Have CV) -->
                        <label class="relative border border-gray-300 rounded-lg p-4 cursor-pointer hover:bg-gray-50 transition-colors flex items-start">
                            <input type="radio" name="cv_status" value="yes" class="h-5 w-5 text-[#950713] focus:ring-[#950713] border-gray-300" {{ old('cv_status') == 'yes' ? 'checked' : '' }} required>
                            <div class="ml-3">
                                <span class="block font-medium text-gray-700">Yes</span>
                        ...
                        <!-- No (Don't have CV) -->
                        <label class="relative border border-gray-300 rounded-lg p-4 cursor-pointer hover:bg-gray-50 transition-colors flex items-start">
                            <input type="radio" name="cv_status" value="no" class="h-5 w-5 text-[#950713] focus:ring-[#950713] border-gray-300" {{ old('cv_status') == 'no' ? 'checked' : '' }} required>
                            <div class="ml-3">
                                <span class="block font-medium text-gray-700">No</span>
                        ...
                        <!-- Will Send (Later) -->
                        <label class="relative border border-gray-300 rounded-lg p-4 cursor-pointer hover:bg-gray-50 transition-colors flex items-start">
                            <input type="radio" name="cv_status" value="will_send" class="h-5 w-5 text-[#950713] focus:ring-[#950713] border-gray-300" {{ old('cv_status') == 'will_send' ? 'checked' : '' }} required>
                            <div class="ml-3">
                ...
                <div class="mb-8">
                    ...
                    <div class="flex rounded-lg overflow-hidden border border-gray-300 focus-within:ring-2 focus-within:ring-[#950713] focus-within:ring-opacity-50 @error('why_instructor') border-red-500 @enderror">
                        ...
                        <textarea name="why_instructor" id="why_instructor" rows="4" class="flex-1 block w-full px-3 py-2 border-0 outline-none" placeholder="Your interest and motivation for teaching technology" required>{{ old('why_instructor') }}</textarea>
                    </div>
                ...
                <div class="mb-4">
                    ...
                    <div class="mt-2">
                        ...
                        <!-- Upload UI - Always visible initially on create form -->
                        <div id="video_upload_container" class="border-2 border-dashed border-gray-300 rounded-lg p-6 flex flex-col items-center justify-center text-center">
                        ...
                        <!-- Video Preview - Always hidden initially on create form -->
                        <div id="video_preview" class="hidden border border-gray-300 rounded-lg overflow-hidden">
                            ...
                            <div class="p-3 bg-gray-50 flex items-center justify-between">
                                <span id="video_name" class="text-sm text-gray-700 truncate"></span>
                        ...
                        <!-- Hidden input to track video removal - Empty by default in create form -->
            ...
            <div class="p-6 sm:p-8 form-section bg-gray-50 border-b border-gray-200">
                ...
                <div class="space-y-6">
                    <div class="flex items-start">
                        <div class="flex items-center h-5">
                            <input type="checkbox" name="confirmation_agreement" id="confirmation_agreement" class="w-5 h-5 rounded text-[#950713] focus:ring-[#950713]" {{ old('confirmation_agreement') ? 'checked' : '' }} value="1" required>
                        </div>
                        <div class="ml-3">
            ...
            <div class="p-6 sm:p-8 form-section border-b border-gray-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <!-- Pending Status -->
                    <label class="relative border border-gray-300 rounded-lg p-4 cursor-pointer hover:bg-gray-50 transition-colors flex items-start">
                        <input type="radio" name="status" value="pending" class="h-5 w-5 text-[#950713] focus:ring-[#950713] border-gray-300" {{ old('status', 'pending') == 'pending' ? 'checked' : '' }} required>
                        <div class="ml-3">
                            <span class="block font-medium text-gray-700">Pending</span>
                            <span class="text-gray-500 text-sm">Application under review</span>
                        </div>
                    </label>
                    
                    <!-- Approved Status -->
                    <label class="relative border border-gray-300 rounded-lg p-4 cursor-pointer hover:bg-gray-50 transition-colors flex items-start">
                        <input type="radio" name="status" value="approved" class="h-5 w-5 text-[#950713] focus:ring-[#950713] border-gray-300" {{ old('status') == 'approved' ? 'checked' : '' }} required>
                        <div class="ml-3">
                            <span class="block font-medium text-gray-700">Approved</span>
                            <span class="text-gray-500 text-sm">Application accepted</span>
                        </div>
                    </label>
                    
                    <!-- Rejected Status -->
                    <label class="relative border border-gray-300 rounded-lg p-4 cursor-pointer hover:bg-gray-50 transition-colors flex items-start">
                        <input type="radio" name="status" value="rejected" class="h-5 w-5 text-[#950713] focus:ring-[#950713] border-gray-300" {{ old('status') == 'rejected' ? 'checked' : '' }} required>
                        <div class="ml-3">
                            <span class="block font-medium text-gray-700">Rejected</span>
                            <span class="text-gray-500 text-sm">Application not accepted</span>
                        </div>
                    </label>
                </div>
            ...
            <div class="p-6 sm:p-8 flex justify-end space-x-3">
                ...
                <button type="submit" class="px-6 py-3 bg-[#950713] text-white font-medium rounded-lg hover:bg-opacity-90 transition-colors">
                    Create Trainer
                </button>
            </div>
        </form>
