    ...
    <div class="bg-white rounded-lg shadow-md overflow-hidden">
        <form action="{{ route('admin.trainers.update', $trainer->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                        ...
                        <div class="flex items-start">
                            <div class="flex items-center h-5">
                                <input type="checkbox" name="expertise_areas[]" id="digital_literacy" value="digital_literacy" class="w-5 h-5 rounded text-[#950713] focus:ring-[#950713]" {{ in_array('digital_literacy', old('expertise_areas', is_array($trainer->expertise_areas) ? $trainer->expertise_areas : json_decode($trainer->expertise_areas, true) ?? [])) ? 'checked' : '' }}>
                            </div>
                            <div class="ml-3">
                        ...
                        <div class="flex items-start">
                            <div class="flex items-center h-5">
                                <input type="checkbox" name="expertise_areas[]" id="graphic_design" value="graphic_design" class="w-5 h-5 rounded text-[#950713] focus:ring-[#950713]" {{ in_array('graphic_design', old('expertise_areas', is_array($trainer->expertise_areas) ? $trainer->expertise_areas : json_decode($trainer->expertise_areas, true) ?? [])) ? 'checked' : '' }}>
                            </div>
                            <div class="ml-3">
                        ...
                        <div class="flex items-start">
                            <div class="flex items-center h-5">
                                <input type="checkbox" name="expertise_areas[]" id="coding" value="coding" class="w-5 h-5 rounded text-[#950713] focus:ring-[#950713]" {{ in_array('coding', old('expertise_areas', is_array($trainer->expertise_areas) ? $trainer->expertise_areas : json_decode($trainer->expertise_areas, true) ?? [])) ? 'checked' : '' }}>
                            </div>
                            <div class="ml-3">
                        ...
                        <div class="flex items-start">
                            <div class="flex items-center h-5">
                                <input type="checkbox" name="expertise_areas[]" id="robotics" value="robotics" class="w-5 h-5 rounded text-[#950713] focus:ring-[#950713]" {{ in_array('robotics', old('expertise_areas', is_array($trainer->expertise_areas) ? $trainer->expertise_areas : json_decode($trainer->expertise_areas, true) ?? [])) ? 'checked' : '' }}>
                            </div>
                            <div class="ml-3">
            ...
            <div class="p-6 sm:p-8 form-section bg-gray-50 border-b border-gray-200">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                        ...
                        <div class="flex items-start">
                            <div class="flex items-center h-5">
                                <input type="checkbox" name="preferred_locations[]" id="east_legon" value="east_legon" class="w-5 h-5 rounded text-[#950713] focus:ring-[#950713]" {{ in_array('east_legon', old('preferred_locations', is_array($trainer->preferred_locations) ? $trainer->preferred_locations : json_decode($trainer->preferred_locations, true) ?? [])) ? 'checked' : '' }}>
                            </div>
                            <div class="ml-3">
                        ...
                        <div class="flex items-start">
                            <div class="flex items-center h-5">
                                <input type="checkbox" name="preferred_locations[]" id="cantonments" value="cantonments" class="w-5 h-5 rounded text-[#950713] focus:ring-[#950713]" {{ in_array('cantonments', old('preferred_locations', is_array($trainer->preferred_locations) ? $trainer->preferred_locations : json_decode($trainer->preferred_locations, true) ?? [])) ? 'checked' : '' }}>
                            </div>
                            <div class="ml-3">
                        ...
                        <div class="flex items-start">
                            <div class="flex items-center h-5">
                                <input type="checkbox" name="preferred_locations[]" id="airport_residential" value="airport_residential" class="w-5 h-5 rounded text-[#950713] focus:ring-[#950713]" {{ in_array('airport_residential', old('preferred_locations', is_array($trainer->preferred_locations) ? $trainer->preferred_locations : json_decode($trainer->preferred_locations, true) ?? [])) ? 'checked' : '' }}>
                            </div>
                            <div class="ml-3">
                        ...
                        <div class="flex items-start">
                            <div class="flex items-center h-5">
                                <input type="checkbox" name="preferred_locations[]" id="other_location_checkbox" value="other" class="w-5 h-5 rounded text-[#950713] focus:ring-[#950713]" {{ in_array('other', old('preferred_locations', is_array($trainer->preferred_locations) ? $trainer->preferred_locations : json_decode($trainer->preferred_locations, true) ?? [])) ? 'checked' : '' }}>
                            </div>
                            <div class="ml-3">
                    ...
                    <div id="other_location_container" class="mt-4 {{ in_array('other', old('preferred_locations', is_array($trainer->preferred_locations) ? $trainer->preferred_locations : json_decode($trainer->preferred_locations, true) ?? [])) ? '' : 'hidden' }}">
            ...
            <div class="p-6 sm:p-8 form-section border-b border-gray-200">
                ...
                <div class="mb-8">
                    <h3 class="text-md font-medium text-gray-800 mb-3">Previous teaching experience <span class="text-red-500">*</span></h3>
                    
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <!-- No Experience -->
                        <label class="relative border border-gray-300 rounded-lg p-4 cursor-pointer hover:bg-gray-50 transition-colors flex items-start">
                            <input type="radio" name="teaching_experience" value="no_experience" class="h-5 w-5 text-[#950713] focus:ring-[#950713] border-gray-300" {{ old('teaching_experience', $trainer->teaching_experience) == 'no_experience' ? 'checked' : '' }} required>
                            <div class="ml-3">
                                <span class="block font-medium text-gray-700">No Experience</span>
                                <span class="text-gray-500 text-sm">New to teaching</span>
                            </div>
                        </label>
                        
                        <!-- 1-2 Years -->
                        <label class="relative border border-gray-300 rounded-lg p-4 cursor-pointer hover:bg-gray-50 transition-colors flex items-start">
                            <input type="radio" name="teaching_experience" value="1_2_years" class="h-5 w-5 text-[#950713] focus:ring-[#950713] border-gray-300" {{ old('teaching_experience', $trainer->teaching_experience) == '1_2_years' ? 'checked' : '' }} required>
                            <div class="ml-3">
                                <span class="block font-medium text-gray-700">1-2 Years</span>
                                <span class="text-gray-500 text-sm">Some experience</span>
                            </div>
                        </label>
                        
                        <!-- 3+ Years -->
                        <label class="relative border border-gray-300 rounded-lg p-4 cursor-pointer hover:bg-gray-50 transition-colors flex items-start">
                            <input type="radio" name="teaching_experience" value="3_plus_years" class="h-5 w-5 text-[#950713] focus:ring-[#950713] border-gray-300" {{ old('teaching_experience', $trainer->teaching_experience) == '3_plus_years' ? 'checked' : '' }} required>
                            <div class="ml-3">
                                <span class="block font-medium text-gray-700">3+ Years</span>
                                <span class="text-gray-500 text-sm">Experienced teacher</span>
                            </div>
                        </label>
                    </div>
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <!-- Have Current CV -->
                        <label class="relative border border-gray-300 rounded-lg p-4 cursor-pointer hover:bg-gray-50 transition-colors flex items-start">
                            <input type="radio" name="cv_status" value="have_cv" class="h-5 w-5 text-[#950713] focus:ring-[#950713] border-gray-300" {{ old('cv_status', $trainer->cv_status) == 'have_cv' ? 'checked' : '' }} required>
                            <div class="ml-3">
                                <span class="block font-medium text-gray-700">I have an up-to-date CV</span>
                                <span class="text-gray-500 text-sm">Ready to submit upon request</span>
                            </div>
                        </label>
                        
                        <!-- Need to Update CV -->
                        <label class="relative border border-gray-300 rounded-lg p-4 cursor-pointer hover:bg-gray-50 transition-colors flex items-start">
                            <input type="radio" name="cv_status" value="need_update" class="h-5 w-5 text-[#950713] focus:ring-[#950713] border-gray-300" {{ old('cv_status', $trainer->cv_status) == 'need_update' ? 'checked' : '' }} required>
                            <div class="ml-3">
                                <span class="block font-medium text-gray-700">I need to update my CV</span>
                                <span class="text-gray-500 text-sm">Will need time to prepare</span>
                            </div>
                        </label>
                    </div>
                ...
                <!-- Motivation -->
                <div class="mb-8">
                    <label for="motivation" class="block text-sm font-medium text-gray-700 mb-1">Why do you want to be a trainer with us? <span class="text-red-500">*</span></label>
                    <div class="flex rounded-lg overflow-hidden border border-gray-300 focus-within:ring-2 focus-within:ring-[#950713] focus-within:ring-opacity-50 @error('motivation') border-red-500 @enderror">
                        ...
                        <textarea name="motivation" id="motivation" rows="4" class="flex-1 block w-full px-3 py-2 border-0 outline-none" placeholder="Your interest and motivation for teaching technology" required>{{ old('motivation', $trainer->motivation) }}</textarea>
                    </div>
                    @error('motivation')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
            ...
            <div class="p-6 sm:p-8 form-section bg-gray-50 border-b border-gray-200">
                ...
                <div class="space-y-6">
                    <div class="flex items-start">
                        <div class="flex items-center h-5">
                            <input type="checkbox" name="agreement" id="agreement" class="w-5 h-5 rounded text-[#950713] focus:ring-[#950713]" {{ old('agreement', $trainer->agreement) ? 'checked' : '' }} required>
                        </div>
                        <div class="ml-3">
                            <label for="agreement" class="text-gray-700">I confirm that the information provided is accurate and complete</label>
