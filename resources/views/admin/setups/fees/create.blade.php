...
<div class="p-6">
    <div class="flex items-center justify-between mb-6">
        <h1 class="text-2xl font-bold text-gray-900">Add New Program Fee</h1>
    ...
    <div class="bg-white rounded-xl shadow-md overflow-hidden">
        ...
        <form action="{{ route('admin.fees.store') }}" method="POST" class="p-6">
            @csrf
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <select name="program_type_id" id="program_type_id" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary" required>
                        ...
                        @foreach($programTypes as $programType)
                            <option value="{{ $programType->id }}" data-name="{{ strtolower($programType->name) }}" {{ old('program_type_id') == $programType->id ? 'selected' : '' }}>
                                {{ $programType->name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div>
                    ...
                    <input type="number" name="amount" id="amount" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary" value="{{ old('amount') }}" min="0" step="0.01" required>
                    <p class="text-gray-500 text-sm mt-1">
                ...
                <div id="partner_discount_div">
                    ...
                    <input type="number" name="partner_discount" id="partner_discount" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary" value="{{ old('partner_discount', 100) }}" min="0" step="0.01" required>
                    <p class="text-gray-500 text-sm mt-1">
                ...
                <div id="school_commission_div" class="hidden">
                    ...
                    <input type="number" name="school_commission" id="school_commission" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary" value="{{ old('school_commission', 0) }}" min="0" step="0.01">
                    <p class="text-gray-500 text-sm mt-1">
                ...
                <div id="imt_commission_div" class="hidden">
                    ...
                    <input type="number" name="imt_commission" id="imt_commission" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary" value="{{ old('imt_commission', 0) }}" min="0" step="0.01">
                    <p class="text-gray-500 text-sm mt-1">
                ...
                <div class="md:col-span-2">
                    <div class="flex items-center">
                        <input type="checkbox" id="is_active" name="is_active" value="1" {{ old('is_active', true) ? 'checked' : '' }} class="h-4 w-4 text-primary focus:ring-primary border-gray-300 rounded">
