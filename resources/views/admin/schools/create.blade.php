                        ...
                        <div class="mt-2">
                            ...
                            <div class="max-w-xl border-2 border-dashed border-gray-300 rounded-lg p-6 bg-gray-50">
                                <div class="flex justify-center mb-4">
                                    ...
                                    <img id="image-preview" class="w-32 h-32 object-cover border rounded-md hidden">
                                    
                                    <!-- Default Icon (Shown when no image) -->
                                    <div id="default-preview" class="w-32 h-32 flex items-center justify-center bg-white border border-gray-300 rounded-md">
                                ...
                                <div class="text-center">
                                    ...
                                    <label class="inline-block px-4 py-2 bg-white border border-gray-300 rounded-md cursor-pointer hover:bg-gray-50 transition-colors">
                                        <span class="text-sm text-gray-700">Choose Logo File</span>
