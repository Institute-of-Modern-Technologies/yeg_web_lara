...
<div class="p-6">
    ...
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-900">Add New Partner School</h1>
        <p class="mt-1 text-sm text-gray-500">Add a new partner school to display in the "Partnered Schools" section</p>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-md overflow-hidden">
        ...
        <div class="p-6">
            <form action="{{ route('admin.partner-schools.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                @csrf
                ...
                <div class="bg-gray-50 p-4 rounded-lg border border-gray-200">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="url" name="website_url" id="website_url" value="{{ old('website_url') }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50" placeholder="https://example.com">
                            ...
                            <div class="space-y-1 text-center">
                                ...
                                <div class="flex text-sm text-gray-600">
                                    <label for="image" class="relative cursor-pointer bg-white rounded-md font-medium text-primary hover:text-red-700 focus-within:outline-none">
                                        <span>Upload school logo/image</span>
