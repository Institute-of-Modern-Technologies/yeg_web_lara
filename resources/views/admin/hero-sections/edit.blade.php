                ...
                <div class="bg-gray-50 p-4 rounded-lg border border-gray-200">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="col-span-1">
                            ...
                            <input type="text" name="title" id="title" value="{{ old('title', $heroSection->title) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50" required>
                        </div>
                ...
                <div class="bg-gray-50 p-4 rounded-lg border border-gray-200">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-4">
                        ...
                        <div>
                            ...
                            <div class="flex items-center">
                                <input type="color" name="text_color" id="text_color" value="{{ old('text_color', $heroSection->text_color) }}" class="h-8 w-8 mr-2 border-0 rounded p-0">
                                <input type="text" value="{{ old('text_color', $heroSection->text_color) }}" class="flex-1 rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50" id="text_color_hex" oninput="document.getElementById('text_color').value = this.value">
                            </div>
                        </div>
