...
<div class="p-6">
    ...
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-900">Create New Hero Section</h1>
        <p class="mt-1 text-sm text-gray-500">Add a new hero section to display on your website's homepage</p>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-md overflow-hidden">
        ...
        <div class="p-6">
            <form action="{{ route('admin.hero-sections.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                @csrf
                ...
                <div class="bg-gray-50 p-4 rounded-lg border border-gray-200">
                    ...
                    <div class="mt-4">
                        ...
                        <input type="text" name="brand_text" id="brand_text" value="{{ old('brand_text') }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50">
                ...
                <div class="bg-gray-50 p-4 rounded-lg border border-gray-200">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="button_text" id="button_text" value="{{ old('button_text') }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50">
                        ...
                        <div>
                            ...
                            <input type="text" name="button_link" id="button_link" value="{{ old('button_link') }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50">
                        </div>
                    </div>
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg border border-gray-200 mt-4">
                        ...
                        <div>
                            ...
                            <div class="flex items-center">
                                <input type="color" name="overlay_color" id="overlay_color" value="{{ old('overlay_color', '#000000') }}" class="h-8 w-8 mr-2 border-0 rounded p-0">
                                <input type="text" value="{{ old('overlay_color', '#000000') }}" class="flex-1 rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50" id="overlay_color_hex" oninput="document.getElementById('overlay_color').value = this.value">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="flex items-center">
                                <input type="range" name="overlay_opacity" id="overlay_opacity" min="0" max="1" step="0.1" value="{{ old('overlay_opacity', 0.5) }}" class="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer">
                                <span class="ml-2 text-sm text-gray-500" id="opacity-value">0.5</span>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        imageInput.addEventListener('change', function() {
            console.log('File selected in hero section:', this.files[0]);
            ...
            if (this.files && this.files[0]) {
                ...
                reader.onload = function(e) {
                    console.log('Hero section image loaded via FileReader');
                    img.src = e.target.result;
                    imagePreview.classList.remove('hidden');
                    console.log('Hero section preview should now be visible');
                };
