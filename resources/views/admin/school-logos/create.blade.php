...
@section('title', 'Add New School Logo')

@section('content')
<div class="p-6">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold text-gray-900">Add New School Logo</h1>
    ...
    <div class="bg-white rounded-xl shadow-md overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200 bg-gray-50 flex items-center">
            ...
            <h2 class="font-semibold text-gray-800">Add New School Logo</h2>
        </div>
        <div class="p-6">
            <form action="{{ route('admin.school-logos.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        ...
                        <div class="relative rounded-md shadow-sm">
                            ...
                            <input type="text" class="pl-10 w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50 @error('name') border-red-300 @enderror" 
                                id="name" name="name" value="{{ old('name') }}" placeholder="Enter school name" required>
                        </div>
                        @error('name')
                    ...
                    <div>
                        ...
                        <div class="relative rounded-md shadow-sm">
                            ...
                            <input type="number" class="pl-10 w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50 @error('display_order') border-red-300 @enderror" 
                                id="display_order" name="display_order" value="{{ old('display_order', 0) }}" min="0" placeholder="0">
                        </div>
                        @error('display_order')
                            <p class="mt-1 text-sm text-red-600"><i class="fas fa-exclamation-circle mr-1"></i>{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        <label for="logo" class="block text-sm font-medium text-gray-700 mb-1">Logo Image <span class="text-red-500">*</span></label>
                            ...
                            <div class="space-y-1 text-center">
                                ...
                                <div class="flex text-sm text-gray-600">
                                    <label for="logo" class="relative cursor-pointer bg-white rounded-md font-medium text-primary hover:text-primary-dark focus-within:outline-none">
                                        ...
                                        <input id="logo" name="logo" type="file" accept="image/*" required class="sr-only">
                                    </label>
                        ...
                        <div id="logo-preview-container" class="mt-3 hidden">
                            ...
                            <div class="h-32 w-auto border rounded p-1 bg-gray-50 inline-block">
                                <img id="logo-preview" class="h-full w-auto object-contain" alt="Logo preview">
                            </div>
                        </div>
                    </div>
