...
<div class="p-6">
    ...
    <div class="mb-6">
        ...
        <p class="mt-1 text-sm text-gray-500">Add a new testimonial to display in the "What Our Community Says" section</p>
    </div>
        ...
        <div class="p-6">
            <form action="{{ route('admin.testimonials.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="bg-gray-50 p-4 rounded-lg border border-gray-200">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="col-span-1">
                            ...
                            <input type="text" name="role" id="role" value="{{ old('role') }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50" placeholder="e.g. Student, Parent, Teacher">
                        </div>
                    </div>
                    ...
                    <div class="mt-4">
                        ...
                        <input type="text" name="institution" id="institution" value="{{ old('institution') }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50" placeholder="e.g. School name, Organization">
                    </div>
                </div>
                ...
                <div class="bg-gray-50 p-4 rounded-lg border border-gray-200">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="flex items-center space-x-2">
                            ...
                            <span id="rating-text" class="text-sm text-gray-600">5 stars</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gray-50 p-4 rounded-lg border border-gray-200">
                    ...
                    <div class="mb-4">
                        <label for="image" class="block text-sm font-medium text-gray-700 mb-1">Upload Image <span class="text-red-500">*</span></label>
