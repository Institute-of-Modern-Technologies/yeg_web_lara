...
<div class="p-6">
    ...
    <div class="mb-6">
        ...
        <p class="mt-1 text-sm text-gray-500">Update details for "{{ $event->title }}"</p>
    </div>
                ...
                <div class="bg-gray-50 p-4 rounded-lg border border-gray-200">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="col-span-1">
                            ...
                            <input type="text" name="title" id="title" value="{{ old('title', $event->title) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50" required>
                        </div>

                        <!-- Display Order -->
                        <div class="col-span-1">
                            <label for="display_order" class="block text-sm font-medium text-gray-700 mb-1">Display Order</label>
                            <input type="number" name="display_order" id="display_order" value="{{ old('display_order', $event->display_order) }}" min="0" class="w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50">
                    ...
                    <div class="mt-4">
                        ...
                        <textarea name="description" id="description" rows="3" class="w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50">{{ old('description', $event->description) }}</textarea>
                    </div>

                    <!-- Status -->
                    <div class="mt-4">
                        <div class="flex items-center">
                            <input type="checkbox" name="is_active" id="is_active" value="1" {{ old('is_active', $event->is_active) ? 'checked' : '' }} class="h-4 w-4 text-primary focus:ring-primary border-gray-300 rounded">
                ...
                <div class="bg-gray-50 p-4 rounded-lg border border-gray-200">
                        ...
                        <div class="rounded-lg overflow-hidden w-full max-w-md border border-gray-300 bg-gray-100">
                            ...
                            @else
                                <div class="flex items-center justify-center h-48 bg-gray-900 text-white p-4">
                                    ...
                                    <span>Video file: {{ basename($event->media_path) }}</span>
                                </div>
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <select name="media_type" id="media_type" class="w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50" required>
                            <option value="image" {{ old('media_type', $event->media_type) == 'image' ? 'selected' : '' }}>Image</option>
                            <option value="video" {{ old('media_type', $event->media_type) == 'video' ? 'selected' : '' }}>Video</option>
                        </select>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md">
                            <div class="space-y-1 text-center">
                                <div id="image-preview-container" class="mb-3 {{ $event->featured_image ? '' : 'hidden' }}">
                                    <x-image id="image-preview" class="max-h-64 rounded border shadow-sm" src="{{ $event->featured_image ? 'storage/' . $event->featured_image : '' }}" alt="Event featured image" />
                                </div>
                ...
                <div class="bg-gray-50 p-4 rounded-lg border border-gray-200">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="duration" id="duration" value="{{ old('duration', $event->duration) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50" placeholder="e.g. 2 days, 1 week">
                        </div>

                        <!-- Level -->
                        <div>
                            <label for="level" class="block text-sm font-medium text-gray-700 mb-1">Level</label>
                            <input type="text" name="level" id="level" value="{{ old('level', $event->level) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50" placeholder="e.g. Beginner, Intermediate, Advanced">
                        </div>
                    </div>
                    ...
                    <div class="mt-4">
                        ...
                        <div class="flex items-center">
                            <input type="color" name="level_color" id="level_color" value="{{ old('level_color', $event->level_color) }}" class="h-8 w-8 mr-2 border-0 rounded p-0">
                            <input type="text" value="{{ old('level_color', $event->level_color) }}" class="flex-1 rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50" id="level_color_hex" oninput="document.getElementById('level_color').value = this.value">
                        </div>
                    </div>
                </div>
