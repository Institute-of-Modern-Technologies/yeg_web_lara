        ...
        <div :class="{'translate-x-0': sidebarOpen, '-translate-x-full': !sidebarOpen}" 
            ...
            <nav class="mt-5 px-4">
                <div class="mb-4">
                    ...
                    <a href="{{ route('admin.challenge-questions.index') }}" 
                       class="group flex items-center px-4 py-2.5 text-sm font-medium rounded-lg mb-2 sidebar-link {{ request()->routeIs('admin.dashboard') || request()->routeIs('admin.challenge-questions.*') ? 'active-nav-link' : 'text-gray-600' }}">
                        <i class="fas fa-question-circle mr-3 {{ request()->routeIs('admin.dashboard') || request()->routeIs('admin.challenge-questions.*') ? 'text-white' : 'text-gray-400' }}"></i>
                        Challenge Questions
                    </a>
                </div>
                <div class="mb-6">
