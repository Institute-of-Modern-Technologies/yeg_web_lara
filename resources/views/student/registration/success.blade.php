                    ...
                    <div class="flex">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-md text-gray-700 mt-2">
                                Your registration is currently under review by our admissions team. Once approved, your <span class="font-semibold">login credentials will be automatically sent to your email</span>. Please check your Gmail inbox regularly for updates.
                            </p>
                            <div class="mt-3 p-3 bg-gray-100 rounded-md">
                                <p class="text-sm flex items-center">
                                    ...
                                    <span><strong>Important Note:</strong> If you don't have a Gmail account or don't receive your credentials within 48 hours of approval, please contact our admin at <a href="mailto:admin@yeg.edu" class="text-blue-600 underline">admin@yeg.edu</a> or call <a href="tel:+1234567890" class="text-blue-600 underline">+123-456-7890</a>.</span>
                                </p>
                            </div>
                        </div>
                    </div>
